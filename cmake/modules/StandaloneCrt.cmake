...
if(USE_MICRO)
  ...
  function(tvm_crt_define_targets)
    ...
    list(APPEND CRT_FILE_COPY_JOBS
         "${PROJECT_SOURCE_DIR}/3rdparty/libcrc/include *.h -> include"
         "${PROJECT_SOURCE_DIR}/3rdparty/libcrc/src crcccitt.c -> src/runtime/crt/microtvm_rpc_common"
         "${PROJECT_SOURCE_DIR}/3rdparty/libcrc/tab gentab_ccitt.inc -> src/runtime/crt/tab"
         "${PROJECT_SOURCE_DIR}/3rdparty/dlpack/include *.h -> include"
         "${PROJECT_SOURCE_DIR}/3rdparty/dmlc-core/include *.h -> include"
         "${PROJECT_SOURCE_DIR}/include/tvm/runtime c_*_api.h -> include/tvm/runtime"
         "${PROJECT_SOURCE_DIR}/include/tvm/runtime/crt *.h -> include/tvm/runtime/crt"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt Makefile -> ."
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/include *.h -> include"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/common *.c -> src/runtime/crt/common"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/graph_executor *.c -> src/runtime/crt/graph_executor"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/graph_executor_module *.c -> src/runtime/crt/graph_executor_module"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/host *.cc -> template/host"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/host *.py -> template/host"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/host Makefile -> template/host"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/memory *.c -> src/runtime/crt/memory"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/microtvm_rpc_common *.cc -> src/runtime/crt/microtvm_rpc_common"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt/microtvm_rpc_server *.cc -> src/runtime/crt/microtvm_rpc_server"
         "${PROJECT_SOURCE_DIR}/src/runtime/minrpc *.h -> src/runtime/minrpc"
         "${PROJECT_SOURCE_DIR}/src/support generic_arena.h -> src/support"
         "${PROJECT_SOURCE_DIR}/src/runtime/crt crt_config-template.h -> template"
         )
